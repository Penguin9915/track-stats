...
public interface LocalizableAction extends Action{
    
    /**
     * Prefix found before action attributes in language files.
     * @return String containing prefix
     */
    String getActionKeyPrefix();
}
